        ...
        <div className="grid md:grid-cols-2 gap-8">
          {filteredProjects.map((project, index) => (
            <motion.div
              ...
              className={`group glass-card rounded-3xl overflow-hidden ${index === filteredProjects.length - 1 && filteredProjects.length % 2 !== 0 ? 'md:col-span-2 md:w-[calc(50%-1rem)] md:mx-auto' : ''}`}
            >
              {/* Project Header */}
